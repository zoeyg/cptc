...
echo "${G1}Start a new terminal or 'source ~/.zshrc' to load new env variables and aliases"
echo "You'll have to use sudo for cme and docker until you restart/relog${NC}"